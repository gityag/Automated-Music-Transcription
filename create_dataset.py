...
def load_segment_of_audio_and_save(audio_file, start, audio_segment_length, midi_segment_length, duration_song, sr,
    ...
    filename_format = "C:/Users/Dell/Desktop/SIC_Project/audio_and_midi/segments/audio/{0}_start_time_{1}.wav"
...
def reconstruct_midi(midi_filename, midi_segments, absolute_ticks_last_note, length_in_secs_full_song):
    ...
    for midi_segment in midi_segments:
        ...
        # filename_format = ""C:\Users\Dell\Desktop\SIC PRoject"/audio_and_midi/segments/midi/{0}_start_time_{1}.mid"
...
def preprocess_audio_and_midi(directory_str):
    ...
    for audio_file in audio_files:
        ...
        audio_start_times, audio_segment_length, midi_segment_length = audio_timestamps(audio_file, audio_decoded)
        midi_file = load_midi(directory_str, audio_file)
        print(midi_file)
        duration_song = librosa.core.get_duration(y=time_series, sr=sr)
        # duration_song = librosa.core.get_duration()
...
def main():
    ...
    directory_str = "C:/Users/Dell/Desktop/SIC_Project/audio_midi/"
